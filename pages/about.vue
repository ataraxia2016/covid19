<template>
  <div class="About">
    ...
    <TextCard>
      {{
        $t(
          '当サイトは新型コロナウイルス感染症 (COVID-19) に関する情報を提供するために、東京都新型コロナ感染症対策サイトのソースコードを元に新潟県に関係する医師と技術者（主に HorliX 開発チーム）が共同で開発・開設したものです。'
        )
      }}<br />
      <br />
      {{
    ...
    >
      {{ $t('PHAZOR') }}<br />
      {{ $t('HorliX 開発チーム') }}:
      <a href="https://phazor.info/HorliX-J">PHAZOR　HPV </a>
    </TextCard>
  </div>
</template>
